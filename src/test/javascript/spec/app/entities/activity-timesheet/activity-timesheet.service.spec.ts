...
describe('Service Tests', () => {
  describe('ActivityTimesheet Service', () => {
    let injector: TestBed;
    let service: ActivityTimesheetService;
    let httpMock: HttpTestingController;
    let elemDefault: IActivityTimesheet;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ActivityTimesheet', async () => {
        ...
        service
          .create(new ActivityTimesheet(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ActivityTimesheet', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should return a list of ActivityTimesheet', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            description: 'BBBBBB',
      ...
      it('should delete a ActivityTimesheet', async () => {
