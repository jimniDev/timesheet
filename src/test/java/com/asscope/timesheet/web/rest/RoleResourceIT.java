...
public class RoleResourceIT {
    ...
    @Test
    @Transactional
    public void getAllRolesByActivityIsEqualToSomething() throws Exception {
        // Initialize the database
        ...
        // Get all the roleList where activity equals to activityId
        defaultRoleShouldBeFound("activityId.equals=" + activityId);

        // Get all the roleList where activity equals to activityId + 1
        defaultRoleShouldNotBeFound("activityId.equals=" + (activityId + 1));
    }
