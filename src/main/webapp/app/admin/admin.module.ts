...
import { ActivityConfigComponent, Dialogrolecreation } from './activity-config/activity-config.component';
...
@NgModule({
  ...
  entryComponents: [JhiHealthModalComponent, ActivityConfigComponent, Dialogrolecreation],
